...
void WriteToFile(unsigned long Time, uint8_t ch1, uint8_t ch2, uint8_t,ch3,char filename);
...
*********************************************************************************************************
*/
void WriteToFile(unsigned long TimeSec, uint8_t ch1, uint8_t ch2, uint8_t,ch3, char filename); {
	int length = sizeof(TimeSec) / sizeof(TimeSec[0]);
	char buffer[100];
