...
*   resolvidos para viabilizar a execu��o do "ads1256_test" fora do loop. 
...
int  adcStart(int argc, char *par1, char *par2, char *par3)
{
   ...
   { 
		...
		// Se n�o for nenhum destes parametros, ent�o foi setado errado atribuindo portanto '666' para a variavel ads_channel
		else  
		{ 
		...
		// Se n�o for nenhum destes parametros, ent�o foi setado errado atribuindo portanto '666' para a variavel ads_gain
		else  
		{ 
		...
		// Se n�o for nenhum destes parametros, ent�o foi setado errado atribuindo portanto '666' para a variavel ads_sps
		else  
		{ 
		...
		// Se um dos parametros ficou marcado como '666', ent�o h� erros e portanto exibe a mensagem de erro.
